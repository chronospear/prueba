...
<div class="col-md-12">
		<div class="card">
            ...
            <form action="{{ route('vendedores.update' , $seller->id) }}" method="POST">
            @csrf
            @method('PUT')
			<div class="card-body">
            ...
            <div class="form-group form-show-validation row">
                            ...
                            <div class="col-lg-4 col-md-9 col-sm-8">
                                <input type="text" class="form-control {{$errors->has('nombre')?'is-invalid':''}}" name="nombre" value="{{ isset($seller->name)?  $seller->name:old('nombre') }}" placeholder="Ingrese el nombre">
                                    @error('nombre')
                        ...
                        <div class="form-group form-show-validation row">
                            ...
                            <div class="col-lg-4 col-md-9 col-sm-8">
                                <input type="text" class="form-control {{$errors->has('apellidos')?'is-invalid':''}}" name="apellidos"  value="{{ isset($seller->last_name)?  $seller->last_name:old('apellidos') }}" placeholder="Ingrese los apellidos">
                                    @error('apellidos')
                                    <small class="text-danger">{{ $message }}</small>
                                    @enderror
                            </div>
                        ...
                        <div class="form-group form-show-validation row">
                            ...
                            <div class="col-lg-4 col-md-9 col-sm-8">
                                <input type="text" class="form-control {{$errors->has('rut')?'is-invalid':''}}" name="rut"  value="{{ isset($seller->rut)?  $seller->rut:old('rut') }}" oninput="checkRut(this)" maxlength="10"  placeholder="Ingrese el rut">
